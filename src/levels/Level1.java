...
public class Level1 {
    ...
    public static void main(String[] args) {
         ...
         */
        employees.stream().filter(t -> "JAVA".equalsIgnoreCase(t.getSubject())).distinct()
                .sorted((t1, t2) -> Double.compare(t1.getSalary(), t2.getSalary())).forEach(System.out::println);
        ...
        Teacher highestPaidTeacher = employees.stream().filter(t -> t.getName().startsWith("m"))
                .peek(t -> t.setSalary(t.getSalary() + 200)).max((t1, t2) -> Double.compare(t1.getSalary(), t2.getSalary()))
                .orElse(null);
