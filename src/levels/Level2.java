...
public class Level2 {
    ...
    public static void main(String[] args) {
        ...
        long sum = teachers.stream().filter(t -> "Flutter".equalsIgnoreCase(t.getSubject()))
        ...
        double average = teachers.stream().filter(t -> t.getName().startsWith("a") && t.getSalary() != null)
                .mapToDouble(Teacher::getSalary).average().orElse(0);
        ...
        boolean test = teachers.stream().anyMatch(t -> t.getSalary() != null && t.getSalary() > 100000);
        ...
        /* First way */
        teachers.stream().filter(t -> "Unity".equalsIgnoreCase(t.getSubject()) && t.getName().startsWith("g"))
